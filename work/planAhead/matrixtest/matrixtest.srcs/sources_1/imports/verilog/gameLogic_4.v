...
module gameLogic_4 (
  ...
  levelButtonState_12 levelButtonState (
    .clk(clk),
    .rst(rst),
  ...
  always @* begin
    ...
    case (M_playing_q)
      NOT_PLAYING_playing: begin
        ...
        M_alu_alufn = 6'h32;
        M_alu_a = M_levelButtonState_count;
        M_alu_b = 1'h1;
        levelButtonCheck = M_alu_out[0+0-:1];
        if (levelButtonCheck == 1'h1) begin
          if (M_level_q == 26'h2faf080) begin
        ...
        if (M_timeToUpdateMap_q < M_level_q - 1'h1) begin
          ...
          if (p1ButtonInput[3+0-:1] == 1'h0) begin
            ...
            if (p1ButtonInput[2+0-:1] == 1'h0) begin
              if (M_p1State_q == U_p1State) begin
              ...
              if (p1ButtonInput[1+0-:1] == 1'h0) begin
                if (M_p1State_q == R_p1State) begin
                ...
                if (p1ButtonInput[0+0-:1] == 1'h0) begin
                  if (M_p1State_q == L_p1State) begin
          ...
          if (p2ButtonInput[3+0-:1] == 1'h0) begin
            if (M_p2State_q == D_p2State) begin
            ...
            if (p2ButtonInput[2+0-:1] == 1'h0) begin
              if (M_p2State_q == U_p2State) begin
              ...
              if (p2ButtonInput[1+0-:1] == 1'h0) begin
                if (M_p2State_q == R_p2State) begin
                ...
                if (p2ButtonInput[0+0-:1] == 1'h0) begin
                  if (M_p2State_q == L_p2State) begin
          ...
          if (M_timeToUpdateMap_q == M_level_q - 1'h1) begin
            ...
            if (M_timeToUpdateMap_q == M_level_q) begin
              M_timeToUpdateMap_d = 26'h0000000;
